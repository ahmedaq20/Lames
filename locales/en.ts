    ...
    projects: [
      {
        id: 'hemma-platform',
        category: 'web',
        categoryLabel: 'Web Systems & Humanitarian Operations',
        title: 'Hemma: Integrated Humanitarian Aid Management Platform',
        client: 'Humanitarian & Relief Organizations',
        summary: 'An advanced web platform and smart dashboards for managing humanitarian aid cycles, tracking beneficiaries and families, coordinating distributions and central kitchens, with robust audit logging and reporting.',
        image: '/images/portfolio/hemma-dashboard-en.png',
        tags: ['Web Application', 'Dashboard', 'Relief Operations', 'Beneficiary Management', 'Audit Logs', 'Reports Center'],
        challenge: 'Fragmented beneficiary records, risk of aid duplication, and the critical need to coordinate humanitarian relief distributions transparently, rapidly, and securely under challenging operating conditions.',
        solution: 'Engineered a resilient web portal featuring unified beneficiary registers, central kitchen & sector distribution workflows, granular role-based permissions, and immutable audit logs with real-time telemetry.',
        results: [
          'Efficiently managed and tracked aid distribution for thousands of vulnerable families in real time.',
          'Eliminated distribution overlaps through automated identity verification and centralized registries.',
          'Real-time operations tracking with detailed audit logs and decision-support analytics.',
        ],
      },
      {
        id: 'nexar-hr-system',
        category: 'web',
        categoryLabel: 'Enterprise Resource & HR Systems',
        title: 'Nexar: Complete Resource & HR Management Portal',
        client: 'Enterprise HR & Operations',
        summary: 'An all-in-one web portal for managing employee records, attendance & leaves, contracts, digital archiving, and administrative approval workflows with real-time analytics.',
        image: '/images/portfolio/nexar-hr-en.png',
        tags: ['HR Management', 'ERP Portal', 'Digital Archiving', 'Approvals Workflow', 'Analytics Dashboard', 'Role-Based Access'],
        challenge: 'Difficulty tracking dispersed workforce distribution across multiple regional hubs, sluggish paper-based approval routines, and the absence of a unified executive dashboard for HR operations.',
        solution: 'Architected a comprehensive HR management portal with fine-grained access control, geographic and attendance analytics, secure cloud document archiving, and automated administrative approval workflows.',
        results: [
          'Full automation of HR workflows and administrative approvals, drastically reducing turnaround times.',
          'Instant visibility into workforce distribution, attendance, and staffing across all operational offices.',
          'Bank-grade digital archiving for employee qualifications, contracts, and sensitive documentation.',
        ],
      },
    ],
    cta: {
