export const en = {
  ...
  portfolio: {
    eyebrow: 'Proven Track Record & Case Studies',
    titleMain: 'Engineering That Drives',
    titleAccent: 'Tangible Business Impact',
    description: 'Explore selected complex systems, high-performance web applications, and intelligent automated workflows we engineered for ambitious organizations.',
    quickStats: [
      { value: '100%', label: 'On-Time Project Delivery' },
      { value: '99.99%', label: 'Cloud Infrastructure Uptime' },
      { value: '350+', label: 'Monthly Hours Saved via Automation' },
      { value: '<250ms', label: 'Average Web Response Latency' },
    ],
    filters: {
      all: 'All Projects',
      web: 'Web & Platforms',
    ...
    ui: {
      viewDetails: 'View Case Study & Details',
      closeModal: 'Close Window',
      keyMetrics: 'Key Metrics & Measurable Impact',
      theChallenge: 'The Challenge',
      theSolution: 'The Engineering Solution',
      keyResults: 'Key Results Achieved',
      techStack: 'Technologies Used',
      clientLabel: 'Client Profile',
      allCategory: 'All',
      noProjects: 'No projects found in this category currently.',
      startProjectCta: 'Start a Similar Project Now',
    },
    projects: [
      {
        id: 'b2b-commerce',
        category: 'web',
        categoryLabel: 'Web Engineering & Cloud',
        title: 'Enterprise B2B Commerce & Logistics Platform',
        client: 'Regional Logistics & Supply Group',
        summary: 'Engineered a unified supply-chain portal with live freight tracking, automated quoting, and high-volume order pipelines.',
        image: '/images/portfolio/b2b-commerce.jpg',
        tags: ['Next.js 15', 'Node.js', 'PostgreSQL', 'Redis', 'Docker', 'AWS ECS'],
        metrics: [
          { label: 'Order Processing Speed', value: '+350%' },
          { label: 'Platform Response Time', value: '220ms' },
          { label: 'Data Processing Accuracy', value: '99.8%' },
        ],
        challenge: 'The client suffered from fragmented data across disparate legacy tools and slow manual wholesale order processing that took hours, causing shipping delays and inventory discrepancies.',
        solution: 'Engineered a modular, ultra-responsive web platform powered by Next.js and microservice APIs, paired with Redis caching and an enterprise PostgreSQL database optimized for high concurrency.',
        results: [
          'Reduced wholesale order processing latency from 2 hours to under 3 minutes.',
          'Unified 36 regional logistics hubs into a single real-time telemetry dashboard.',
          'Zero data entry discrepancies due to automated validation pipelines.',
        ],
      },
      {
        id: 'fintech-app',
        category: 'mobile',
        categoryLabel: 'Mobile Engineering & UI/UX',
        title: 'FinTech Wealth Management & Investment App',
        client: 'Licensed Digital Wealth & Asset Manager',
        summary: 'A luxury mobile application enabling instant portfolio management, real-time market feeds, and biometric trading.',
        image: '/images/portfolio/fintech-app.jpg',
        tags: ['Flutter', 'Go (Golang)', 'GraphQL', 'Biometric Auth', 'AWS KMS'],
        metrics: [
          { label: 'App Store Rating', value: '4.9 ★' },
          { label: 'Daily Active Users', value: '60K+' },
          { label: 'Security Compliance', value: '100%' },
        ],
        challenge: 'Delivering an ultra-luxurious, rapid mobile user experience for high-frequency chart updates while strictly adhering to institutional banking encryption protocols.',
        solution: 'Constructed a bespoke Flutter mobile app with streamlined GraphQL subscriptions, a high-throughput Go backend, and hardware biometric encryption.',
        results: [
          'Real-time asset price updates rendered in sub-80ms intervals.',
          'Seamless digital onboarding & KYC completed in under 2 minutes.',
          'Zero security vulnerabilities identified during rigorous independent penetration tests.',
        ],
      },
      {
        id: 'n8n-automation',
        category: 'automation',
        categoryLabel: 'Business Process Automation & n8n',
        title: 'Enterprise AI & n8n Workflow Automation Engine',
        client: 'Enterprise Professional Services Firm',
        summary: 'End-to-end automation of customer onboarding, ticket routing, AI document classification, and bi-directional CRM syncing.',
        image: '/images/portfolio/n8n-automation.jpg',
        tags: ['n8n', 'OpenAI API', 'HubSpot', 'Slack API', 'PostgreSQL', 'Webhooks'],
        metrics: [
          { label: 'Monthly Hours Saved', value: '140+ hrs' },
          { label: 'Ticket Response Time', value: '-80%' },
          { label: 'AI Classification Accuracy', value: '98.5%' },
        ],
        challenge: 'High overhead of manual data entry between email, HubSpot, and spreadsheets, causing customer response delays and dropped leads.',
        solution: 'Architected a resilient n8n automation mesh integrated with LLM agents to auto-classify incoming inquiries, parse documents, update core databases, and dispatch smart Slack alerts.',
        results: [
          'Automated 92% of repetitive operational tasks without manual human intervention.',
          'Dropped inquiry triage turnaround from 45 minutes to 10 seconds.',
          'Saved thousands of dollars monthly in recurring operational overhead.',
        ],
      },
      {
        id: 'cloud-devsecops',
        category: 'cloud',
        categoryLabel: 'Cloud, DevOps & Cybersecurity',
        title: 'Multi-Region Cloud Infrastructure & DevSecOps Suite',
        client: 'FinTech Payment Processing Gateway',
        summary: 'Built a resilient multi-region Kubernetes cloud infrastructure with automated CI/CD pipelines, zero-downtime rollouts, and 24/7 security monitoring.',
        image: '/images/portfolio/cloud-devsecops.jpg',
        tags: ['Kubernetes', 'Terraform', 'AWS Multi-Region', 'GitHub Actions', 'Vault', 'Grafana'],
        metrics: [
          { label: 'System Uptime & Stability', value: '99.99%' },
          { label: 'Deployment Pipeline Time', value: '3 mins' },
          { label: 'Rollout Interruption', value: 'Zero Downtime' },
        ],
        challenge: 'Handling abrupt transaction traffic spikes without performance degradation while meeting rigorous banking PCI-DSS regulatory compliance standards.',
        solution: 'Implemented Infrastructure as Code via Terraform, geographically redundant Kubernetes clusters with predictive auto-scaling, and HashiCorp Vault key management.',
        results: [
          'Smoothly absorbed 10x traffic spikes during seasonal transaction rushes.',
          'Reduced code rollout cycles from one week to 3 minutes.',
          'Passed bank-grade PCI-DSS compliance audits with a 100% score on the first attempt.',
        ],
      },
      {
        id: 'headless-media',
        category: 'web',
        categoryLabel: 'Headless Web & UI/UX',
        title: 'High-Performance Headless Digital Media Portal',
        client: 'Premier Digital Media & Editorial Network',
        summary: 'Ultra-fast headless editorial publication platform featuring interactive articles, multimedia feeds, live reader analytics, and modular design.',
        ...
        metrics: [
          ...
          { label: 'Reader Engagement Growth', value: '+65%' },
          { label: 'Initial Page Load Time', value: '0.4s' },
        ],
        challenge: 'Severe latency and frequent database crashes on a legacy WordPress stack during breaking news traffic spikes, paired with a poor mobile reading experience.',
        solution: 'Re-architected the portal as a decoupled Headless system using Next.js with Incremental Static Regeneration (ISR), edge caching, and a polished editorial design system.',
        results: [
          'Achieved flawless 100/100 Core Web Vitals performance benchmarks.',
          'Maintained 100% uptime during major news events with millions of concurrent readers.',
          'Significant organic SEO ranking improvement across target search categories.',
        ],
      },
      {
        id: 'logistics-delivery',
        category: 'mobile',
        categoryLabel: 'Mobile Logistics & Dispatch',
        title: 'Real-Time Fleet Dispatch & On-Demand Delivery Suite',
        client: 'Last-Mile Delivery & Freight Enterprise',
        summary: 'Synchronized driver app and dispatch command center with dynamic route optimization and live telemetry.',
        image: '/images/portfolio/logistics-delivery.jpg',
        tags: ['React Native', 'FastAPI', 'WebSockets', 'Google Maps API', 'PostGIS'],
        metrics: [
          { label: 'Weekly Shipments Handled', value: '15K+' },
          { label: 'Fuel & Route Optimization', value: '22%' },
          { label: 'ETA Prediction Accuracy', value: '98.1%' },
        ],
        challenge: 'Difficulty in tracking hundreds of couriers simultaneously and inefficient manual dispatching resulting in delivery delays and inflated fuel costs.',
        solution: 'Built a high-performance cross-platform driver app connected via persistent WebSockets, backed by automated dispatch algorithms and geospatial queries.',
        results: [
          'Decreased average last-mile delivery times by 28%.',
          'Smooth live courier telemetry without battery drain issues.',
          'Elevated customer satisfaction to 96% while reducing fuel costs.',
        ],
      },
    ],
    cta: {
      eyebrow: 'Ready to Build Your Next Big Project?',
      title: 'Let’s Turn Your Vision Into an Engineered Reality',
      description: 'The Lames engineering team is ready to design, build, and automate your entire technology ecosystem with uncompromised quality.',
      button: 'Book a Discovery Call for Your Project',
      secondaryButton: 'Chat With Us on WhatsApp',
    },
  },
};
