        ...
        <div className="mb-16 grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-6 lg:col-span-2">
            ...
            <p className="font-display text-lg font-bold text-slate-900 dark:text-white">
              We don&apos;t just build apps. <span className="bg-gradient-to-r from-primary-500 to-accent-500 bg-clip-text text-transparent">We build systems that work for you.</span>
            </p>
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex rounded-full border border-slate-200 px-6 py-3 text-sm font-bold text-slate-700 transition-colors hover:border-primary-500 hover:text-primary-600 dark:border-white/10 dark:text-slate-300 dark:hover:border-primary-500 dark:hover:text-primary-400"
              >
                WhatsApp
              </a>
            </div>
            <a
              href={`mailto:${EMAIL}`}
              className="mt-6 inline-block text-sm font-medium text-slate-600 transition-colors hover:text-primary-600 dark:text-slate-400 dark:hover:text-primary-400"
            >
              {EMAIL}
            </a>
          </div>
